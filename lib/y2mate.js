...
module.exports = {
  ...
  yta(url, resol = '320kbps', server = 'en68') { return yt(url, resol, 'mp3', resol.endsWith('kbps') ? resol.replace(/kbps/g, '') : resol, server) },
  servers: ['id4','en60'],
  
  ytv(url, resol = '360p', server = 'en61') { return yt(url, resol, 'mp4', resol.endsWith('p') ? resol.replace(/p/g, '') : resol, server) },
  servers: ['en68']
}
